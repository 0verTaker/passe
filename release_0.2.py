...
class main_app(MDApp):
    ...
    def hide(self):
        # esconde o valor dos campos 'valor' e 'gasto'
    ...
    def rest_dia(self):
        # calcula a quantidade de dias q o passe pode ser usado 
        # com base no valor gasto em um dia 
        aux2 = self.config.getfloat('value', 'amount')
        new_value = floor(aux2 / 5.46)
        self.kvs.ids.resta.text = f"Restam {new_value} dias"
